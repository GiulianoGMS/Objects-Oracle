...
-- Paliativo Giuliano para reforma
  ...
  -- Variaveis por Item
  psBaseCBSItem  TMP_M014_ITEM.M014_VL_VLRBASECBS%TYPE;
  psBaseIBSItem  TMP_M014_ITEM.M014_VL_VLRBASEIBSUF%TYPE;
  psVlrCBSItem   NUMBER(10,3);
  psVlrIBSItem   NUMBER(10,3);
  psIDItem       NUMBER(10);
...
BEGIN
  ...
  SELECT Y.M014_NR_ITEM, Y.M014_VL_VLRBASECBS / Y.M014_VL_QTDE_COM, ROUND(Y.M014_VL_VLRIMPOSTOCBS / Y.M014_VL_QTDE_COM,3), 
