...
SELECT DISTINCT CODGERALOPER, NROTRIBUTACAO, CONTRIB_ICMS INDCONTRIBICMS,
 ...
 WHERE X.NROREGTRIBUTACAO = 0
  ...
  LOOP
    INSERT INTO MAX_CODGERALCFOP VALUES(tribSP.CODGERALOPER,  tribSP.NROTRIBUTACAO,     tribSP.Indcontribicms,    tribSP.CFOPESTADO,    tribSP.CFOPFORAESTADO,
...
SELECT DISTINCT CODGERALOPER, NROTRIBUTACAO, CONTRIB_ICMS INDCONTRIBICMS,
 ...
 WHERE X.NROREGTRIBUTACAO = 0
   ...
   LOOP
    INSERT INTO MAX_CODGERALCFOP VALUES(tribRJ.CODGERALOPER,  tribRJ.NROTRIBUTACAO,     tribRJ.Indcontribicms,    tribRJ.CFOPESTADO,    tribRJ.CFOPFORAESTADO,
