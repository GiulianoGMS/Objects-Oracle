...
AND F2.DTAVENCIMENTO BETWEEN TRUNC(SYSDATE) AND SYSDATE + 7
    ...
    vtexto := vtexto ||
              to_char(
                ...
                '<TR>
                           ...
                           <TD vAlign=top align=middle ><FONT face=Calibri size=2> ' ||  'DOC C5 :'||TO_CHAR(T2.DOC_C5) ||' - DDA: '||DOCTO_DDA||         ' </FONT></TD>
