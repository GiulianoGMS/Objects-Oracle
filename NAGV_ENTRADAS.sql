CREATE OR REPLACE VIEW NAGV_ENTRADAS AS
SELECT /*+OPTIMIZER_FEATURES_ENABLE('11.2.0.4')*/
       ...
       XX.NROEMPRESA, XI.VLRICMSST, NVL(XI.VLRICMSSTDISTRIB,0) VLRICMSSTRETIDO, NVL(XI.VLRICMSDISTRIB,0) VLRICMSSUBS --, NVL(XI.VLRICMSEFET,0) VLRICMSEFET,
      , XI.VLRIPI, XX.ROWID ID, XI.SITUACAONFIPI
...
*/   AND XX.SERIENF != 'CF'
 ...
 --  AND (XX.TIPNOTAFISCAL = 'S' OR DESCRICAO LIKE '%EMI%' AND TIPCGO = 'E')
   --AND XX.NFECHAVEACESSO IN ('35240107705530000427550010010193951297595681', '35240101838723009850550060131314521405678010')
;
