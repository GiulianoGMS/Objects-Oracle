CREATE OR REPLACE VIEW CONSINCO.MRLV_ETIQ_NAGUMO_VAREJO_VM2 AS
...
--------- QUANDO ESTIVER NA OFERTA E QUANDO OFERTA FOI MENOR QUE PRECOO NORMAL
       ...
       ELSE -- OFERTA NORMAL
        ...
        (CASE WHEN LENGTH(J.PRECOVALIDPROMOC) > 5
        THEN
        '^FO540,90^A0N,130,90^FD'||LPAD(TRUNC(J.PRECOVALIDPROMOC), 4, ' ' ) || ',' || LPAD((J.PRECOVALIDPROMOC - TRUNC(J.PRECOVALIDPROMOC)) * 100, 2, 0)||'^FS'
        ELSE
