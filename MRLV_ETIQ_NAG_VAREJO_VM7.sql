...
--======= Quando existir Meu Nagumo e Oferta Normal
       ...
       THEN                                   CHR(13) || CHR(10) ||
        ...
        '^FO590,221^A0N,15,15^FDNesta Embalagem '||
                                ...
                                TRANSLATE(TO_CHAR(ROUND((RPM.PRECOPROMOCAO/(J.MULTEQPEMB*1000)) * CASE WHEN J.MULTEQPEMBALAGEM IN ('GR','ML') THEN 100000 ELSE 1000 END ,2),'FM9990.00'), '.', ','),
                                TRANSLATE(TO_CHAR(ROUND((RPM.PRECOPROMOCAO/(J.MULTEQPEMB*1000)) * CASE WHEN J.MULTEQPEMBALAGEM IN ('GR','ML') THEN 100000 ELSE 1000 END ,2),'FM9990.00'), '.', ',')) END)||'^FS'|| CHR(13) || CHR(10) ||
...
--======= Preco para Regra de Incentivo + Oferta
      -- Tipo RO
        ...
        '^FO590,221^A0N,15,15^FDNesta Embalagem '||
                                ...
                                TRANSLATE(TO_CHAR(ROUND((RI.PRECO_FINAL/(J.MULTEQPEMB*1000)) * CASE WHEN J.MULTEQPEMBALAGEM IN ('GR','ML') THEN 100000 ELSE 1000 END ,2),'FM9990.00'), '.', ','),
                                TRANSLATE(TO_CHAR(ROUND((RI.PRECO_FINAL/(J.MULTEQPEMB*1000)) * CASE WHEN J.MULTEQPEMBALAGEM IN ('GR','ML') THEN 100000 ELSE 1000 END ,2),'FM9990.00'), '.', ',')) END)||'^FS'|| CHR(13) || CHR(10) ||
        '^FO490,155^GB300,86,51^FR^FS'     || CHR(13) || CHR(10) ||
        '^FO490,60^GB300,85,50^FR^FS'
