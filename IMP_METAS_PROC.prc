...
ON (tgt."DATA" = src."DATA" AND tgt.NRO_EMPRESA = src.NRO_EMPRESA)
WHEN MATCHED THEN
  UPDATE SET
    tgt.CATEGORIA_NIVEL_1 = src.CATEGORIA_NIVEL_1,
    tgt.CATEGORIA_NIVEL_2 = src.CATEGORIA_NIVEL_2,
    tgt.CATEGORIA_NIVEL_3 = src.CATEGORIA_NIVEL_3,
