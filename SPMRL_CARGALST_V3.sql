CREATE OR REPLACE PROCEDURE SPMRL_CARGALST_V3 (psNROEMPRESA          IN   VARCHAR2,
   ...
   BEGIN
     FOR EMP IN (SELECT * FROM MAX_EMPRESA A
                 ...
                 ORDER BY 1 )
     LOOP
       IF psTIPOLOG != 'Não Gera' OR psBALANCA != 'Não Gera' THEN
         ...
         IF psBALANCA = 'Parcial' THEN
          -- Gera Parcial     
             BEGIN
              ...
              ESPP_CPT_GERACARGATOLETO(emp.NROEMPRESA,SYSDATE, 'N');
               COMMIT;   
